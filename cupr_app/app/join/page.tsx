...
import { X, ArrowRight, ShieldCheck, Zap, LineChart, Sparkles, CheckCircle2, AlertCircle } from 'lucide-react';
              ...
              <div className="p-8 pb-10">
                ...
                {submitState === 'success' ? (
                  <div className="flex flex-col items-center gap-4 py-6 text-center">
                    ...
                    <p className="text-white font-light">Request received. We will be in touch soon.</p>
                  </div>
                ) : (
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className="w-full bg-white text-black font-mono text-xs uppercase tracking-widest py-4 rounded-lg hover:bg-neutral-200 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {submitState === 'loading' ? 'Submitting…' : (<>Request Access <ArrowRight className="w-4 h-4" /></>)}
                    </button>
                  </form>
                )}
